...
plot(After.Move, Winners, pch=19, col="darkgreen", type="b", ylim=c(0, 40),
     main="Mobility of Winners (green), Losers (red), and Difference (blue)
     in 78 Games, per E. Slater, 1950",
     xlab="After Move", ylab="Mean Mobiilty of Winners, Losers and their Difference")
...
plot(mob.adv, fP, pch=19, col="blue", type="b",
     main="Means (blue) from 380 Games at 20th Move:
     Slater's Regression (black) vs. Least Squares Fit (red)",
